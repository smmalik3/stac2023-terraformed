...
module.exports.readS3File = async (event) => {
  ...
  try {
    ...
    try {
      ...
      const prompt = "This is the resume to consider: " + resume + "\n\n" + "Please compare the resume to the following job description: \n\n" + jobDescription + "\n\nDoes the candidate appear to have relevant experience for the above job description? Start your response with the word 'Yes' or the word 'No' before sharing your reasoning."
