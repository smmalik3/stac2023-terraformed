...
function constructPrompt(jobDescription) {
	...
	return 'Write a job description for a ' + jobDescription.agency + ' ' + jobDescription.title + ' with a ' + jobDescription.education + ' or ' + jobDescription.yearsOfExperience + ' years of experience. The job is ' + jobDescription.classification + ' located in ' + jobDescription.location + ' with a salary range of ' + jobDescription.salaryMin + ' to ' + jobDescription.salaryMax + '.';
}
...
function callOpenAI(prompt) {
    try {
        ...
        restMessage.setRequestHeader('Authorization', 'Bearer <ADD API KEY HERE>');
